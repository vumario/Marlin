 ...
 *
 */
<<<<<<< HEAD:Marlin/example_configurations/delta/kossel_mini/Configuration.h
#ifndef CONFIGURATION_H
#define CONFIGURATION_H
#define CONFIGURATION_H_VERSION 010109
=======
#define CONFIGURATION_H_VERSION 020000
>>>>>>> upstream/bugfix-2.0.x:Marlin/src/config/examples/delta/kossel_mini/Configuration.h
