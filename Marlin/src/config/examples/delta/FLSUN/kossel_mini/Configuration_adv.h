 ...
 *
 */
<<<<<<< HEAD:Marlin/example_configurations/delta/kossel_pro/Configuration_adv.h
#ifndef CONFIGURATION_ADV_H
#define CONFIGURATION_ADV_H
#define CONFIGURATION_ADV_H_VERSION 010109
=======
#define CONFIGURATION_ADV_H_VERSION 020000
>>>>>>> upstream/bugfix-2.0.x:Marlin/src/config/examples/delta/FLSUN/kossel_mini/Configuration_adv.h
